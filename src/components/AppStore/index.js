...
class AppStore extends Component {
  ...
  render() {
    ...
    let filterProjects = this.getFilterProjects()
    filterProjects = filterProjects.filter(each =>
        ...
        <div>
          ...
          <ul className="tabs-container">
            {tabsList.map(eachTab => (
              <TabItem
                tabDetails={eachTab}
                key={eachTab.tabId}
                clickTabItem={this.clickTabValue}
          ...
          <ul className="apps-container">
            {filterProjects.map(eachProject => (
              <AppItem key={eachProject.appId} projectDetails={eachProject} />
            ))}
          </ul>
        </div>
      </div>
